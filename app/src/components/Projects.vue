<template>
  <div id='projects'>
    <div class="slider | js-drag-area" id="slider">
      <div class="slider__inner | js-slider">
        <div class="slide | js-slide">
          <div class="slide__inner | js-slide__inner">
            <img class="js-slide__img" src="@/assets/test/1.jpeg" alt="" crossorigin="anonymous" draggable="false">
          </div>
        </div>
        <div class="slide | js-slide" style="left: 120%;">
          <div class="slide__inner | js-slide__inner">
            <img class="js-slide__img" src="@/assets/test/2.jpeg" alt="" crossorigin="anonymous" draggable="false">
          </div>
        </div>
...
window.addEventListener("load", function() {
  ...
  class Gl {
    ...
    init() {
      ...
      document.getElementById("slider").appendChild(domEl);
    }}
